...
public class Ancien extends ApplicationAdapter {
    ...
    private void dessiner() {
        ...
        for (int i = 0; i < coordsX.length; i++) {
            ...
            batch.draw(img, coordsX[i], coordsY[i], longueur / 2, hauteur / 2, longueur, hauteur, 1, 1, rotations[i], 0,
                    0, img.getWidth(), img.getHeight(), false, false);
        }
        batch.end();
    }
